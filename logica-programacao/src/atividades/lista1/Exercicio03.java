...
public class Exercicio03 {
    public static void main(String[] args) {
        ...
        while (eleitor <= 0) {
            ...
            System.out.println("Digite novamente a quantidade de Eleitor do Municipio:");
            eleitor = scan.nextInt();
        }
        ...
        while (branco < 0) {
            ...
            System.out.println("Digite novamente a quantidade de Voto em Branco:");
            branco = scan.nextInt();
        }
        ...
        while (nulo < 0) {
            ...
            System.out.println("Digite novamente a quantidade de Voto NULO:");
            nulo = scan.nextInt();
        }
        ...
        while (voto < 0) {
            ...
            System.out.println("Digite novamente a quantidade de Voto Válido:");
            nulo = scan.nextInt();
        }
